...
foreach ( $i in $OnlineComputers ) {
    ...
    Invoke-Command -Session $session -JobName 'ADMU-DISCOVERY' -ScriptBlock {
        ...
        $Win32UserProfiles | Add-Member -MemberType NoteProperty -Name ComputerName -Value $null
        ...
        $Win32UserProfiles | Add-Member -MemberType NoteProperty -Name DomainUserName -Value $null
