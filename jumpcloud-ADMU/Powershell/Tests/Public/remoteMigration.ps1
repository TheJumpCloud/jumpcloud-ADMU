...
$JumpCloudAPIKey = 'TEST' # This field is required if the device is not eligible to use the systemContext API/ the systemContextBinding variable is set to false
$JumpCloudOrgID = 'TEST' # This field is required if you use a MTP API Key
