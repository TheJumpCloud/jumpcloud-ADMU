...
'@
    ...
    $JCLogoImg.Source = Get-DecodedImage -ImageBase64 $JCLogoBase64
    $img_ckey_info.Source = Get-DecodedImage -ImageBase64 $BlueBase64
    $img_ckey_valid.Source = Get-DecodedImage -ImageBase64 $ErrorBase64
    $img_apikey_info.Source = Get-DecodedImage -ImageBase64 $BlueBase64
    $img_apikey_valid.Source = Get-DecodedImage -ImageBase64 $ErrorBase64
    $img_localaccount_info.Source = Get-DecodedImage -ImageBase64 $BlueBase64
    $img_localaccount_valid.Source = Get-DecodedImage -ImageBase64 $ErrorBase64
    $img_localaccount_password_info.Source = Get-DecodedImage -ImageBase64 $BlueBase64
    $img_localaccount_password_valid.Source = Get-DecodedImage -ImageBase64 $ActiveBase64
    ...
    $tbJumpCloudUserName.add_TextChanged( {
            ...
            If ((Test-IsNotEmpty $tbJumpCloudUserName.Text) -or (!(Test-HasNoSpace $tbJumpCloudUserName.Text)) -or (Test-Localusername $tbJumpCloudUserName.Text) -or (($tbJumpCloudUserName.Text).Length -gt 20) -or $tbJumpCloudUserName.Text -eq $hostname) {
                ...
                $img_localaccount_valid.Source = Get-DecodedImage -ImageBase64 $ActiveBase64
    ...
    $tbJumpCloudConnectKey.Add_PasswordChanged( {
            ...
            If (((Test-CharLen -len 40 -testString $tbJumpCloudConnectKey.Password) -and (Test-HasNoSpace $tbJumpCloudConnectKey.Password)) -eq $false) {
                ...
                $tbJumpCloudConnectKey.FontWeight = "Normal"
                $tbJumpCloudConnectKey.BorderBrush = "#FFC6CBCF"
                $img_ckey_valid.Source = Get-DecodedImage -ImageBase64 $ActiveBase64
    ...
    $tbJumpCloudAPIKey.Add_PasswordChanged( {
            ...
            If (((Test-CharLen -len 40 -testString $tbJumpCloudAPIKey.Password) -and (Test-HasNoSpace $tbJumpCloudAPIKey.Password)) -eq $false) {
                ...
                try {
                    ...
                    $tbJumpCloudAPIKey.FontWeight = "Normal"
                    $tbJumpCloudAPIKey.BorderBrush = "#FFC6CBCF"
                    $img_apikey_valid.Source = Get-DecodedImage -ImageBase64 $ActiveBase64
    ...
    $tbTempPassword.add_TextChanged( {
            ...
            If ((!(Test-IsNotEmpty $tbTempPassword.Text) -and (Test-HasNoSpace $tbTempPassword.Text)) -eq $false) {
                ...
                $img_localaccount_password_valid.Source = Get-DecodedImage -ImageBase64 $ErrorBase64
