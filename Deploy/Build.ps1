...
$masteruwp = (Invoke-WebRequest https://raw.githubusercontent.com/TheJumpCloud/jumpcloud-ADMU/master/Deploy/uwp_jcadmu.ps1).tostring() | Out-File -FilePath C:\windows\Temp\master.ps1
