...
If (-not [System.String]::IsNullOrEmpty($NewContent))
{
    ...
    {
    Invoke-ps2exe -inputFile "C:\Users\circleci\project\Deploy\ADMU.ps1" -outputFile "C:\Users\circleci\project\jumpcloud-ADMU\exe\gui_jcadmu.exe" -title "JumpCloud ADMU" -product "JumpCloud ADMU" -description "JumpCloud AD Migration Utility" -copyright "(c) 2021" -version $Version.Matches.Value -company "JumpCloud" -requireAdmin -iconfile "C:\Users\circleci\project\Deploy\admu.ico"
