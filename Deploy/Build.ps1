...
Write-Host "[Status]: Building new ADMU.ps1 file from Start-JCADMU, Form, and, Start-Migration scritps"
...
If ($PSVersion.PSEdition -eq "Core") {
    Write-Warning "Building ADMU exe binary files requires SowerShell Non-Core edition and a windows host"
} else {
